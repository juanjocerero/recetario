...
<AlertDialog.Content>
	<AlertDialog.Header>
		...
		<AlertDialog.Description>
			El producto "<strong>{@html productName}</strong>" tiene valores nutricionales incompletos o de valor cero. ¿Quieres añadirlo de todas formas? Podrás editar los valores manualmente.
		</AlertDialog.Description>
	</AlertDialog.Header>
	<AlertDialog.Footer>
